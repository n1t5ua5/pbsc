...
// SmarterTV application
public class SmarterTV {
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("Smarter TV - On Demand");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(400, 200);
        // Next I created the JFrame to generic dimensions

        JLabel label = new JLabel("Select or enter a TV Show:");
        ...
        showButton.addActionListener(e -> {
            ...
            if (tvShows.containsKey(selectedShow)) {
                synopsisArea.setText(tvShows.get(selectedShow));
            } else {
                synopsisArea.setText("Error: The show '" + selectedShow + "' is not available.");
            }
            // The action listener waits to retrieve the synopsis once clicked, if show doesn't exist an error is raised
        });
